...
async function sendNotificationEmail(adminEmail, subject, message) {
    const transporter = nodemailer.createTransport({
      ...
      auth: {
        user: "rakeshdurga4014@gmail.com", // Replace with your email
        pass: "lggf yfnf tipf tlgp", // Replace with your app-specific password
      },
    });
  
    const mailOptions = {
      from: "rakeshdurga4014@gmail.com", // Replace with your email
      to: adminEmail,
      subject: subject,
      text: message,
    };
